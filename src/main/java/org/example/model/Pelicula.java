...
public class Pelicula {
    ...
    public Pelicula(String id, String title, int year, String director,
        ...
        this.description = description; this.imageUrl = imageUrl; this.userId = userId;
    }

    public static Pelicula fromCsv(String line) {
        String[] p = line.split(",", 7); // id,title,year,director,description,imageUrl,userId
        return new Pelicula(
                p[0], p[1], Integer.parseInt(p[2]), p[3], p[4], p[5], p[6]
        );
    }
    ...
    public String toCsv() {
        ...
        return String.join(",", id, title, String.valueOf(year), director, safeDesc, imageUrl, userId);
    }
